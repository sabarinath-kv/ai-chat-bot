...
function App() {
  ...
  const [messages, setMessages] = useState<
    { type: "question" | "answer" | "loading"; text: string }[]
  >([]);
  ...
  const answers = [
    ...
    "Great question! The answer is `code example`.",
    "I understand what you're asking. [Here's a link](https://example.com) with more information.",
  ];
    ...
    setTimeout(() => {
      setMessages((prev) =>
        prev
          ...
          .concat({ type: "answer", text: randomAnswer })
      );
      setIsLoading(false);
    }, 1000);
  };
  ...
  return (
    <div className="app-container">
      <Header />
      <ProductList />
      <ChatButton onClick={() => setIsChatOpen(true)} isVisible={!isChatOpen} />
